...
```
  --user TEXT        User that will connect to the machine through
                     nixos-anywhere.
  --build-on-remote  build the closure on the remote machine instead
                     of locally and copy-closuring it.
  --help             Show this message and exit.
```
