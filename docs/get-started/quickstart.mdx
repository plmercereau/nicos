...
<Steps>
  ...
  <Accordion title="Direnv and nix-direnv (recommended)">
...
Make sure you added the SSH public key of your current user on Hetzner Cloud and added it to this machine. See [Hetzner Cloud documentation](https://community.hetzner.com/tutorials/add-ssh-key-to-your-hetzner-cloud) for more information.
