...
You can find all the configuration options for bastions in the [reference documentation](/reference/machines/nixos#settings-networking-vpn-bastion-enable).
