...
let
  inherit (import ../../lib.nix { inherit lib; })
    compose applyTwice filterEnabled concatMapAttrsToList recursiveMerge
    stringNotEmpty nixosVersionOf;
...
{
  config.lib.ext_lib = {
    inherit compose applyTwice filterEnabled concatMapAttrsToList nixosVersionOf
